    ...
    <div style={{ width:170, height:170, margin:"0 auto 4px", position:"relative" }}>
      <svg width="170" height="170" viewBox="0 0 170 170" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g style={{transformOrigin:"85px 85px", animation:"cmc-ring-cw 11s linear infinite"}}>
          <ellipse cx="85" cy="85" rx="70" ry="22" stroke="#F472B6" strokeWidth="0.8"
        ...
        <g style={{transformOrigin:"85px 85px", animation:"cmc-ring-ccw 15s linear infinite"}}>
          <ellipse cx="85" cy="85" rx="60" ry="19" stroke="#06B6D4" strokeWidth="0.8"
        ...
        <g style={{transformOrigin:"85px 85px", animation:"cmc-ring-tilt 20s linear infinite"}}>
          <ellipse cx="85" cy="85" rx="76" ry="24" stroke="#A78BFA" strokeWidth="0.6"
        ...
        <g style={{transformOrigin:"85px 95px", animation:"cmc-mab-float 3.4s ease-in-out infinite"}}>
          ...
          <line x1="77" y1="84" x2="93" y2="84" stroke="#FBCFE8" strokeWidth="1.2"
            strokeDasharray="2 2" strokeOpacity="0.65"/>
          <line x1="77" y1="89" x2="93" y2="89" stroke="#FBCFE8" strokeWidth="1.2"
            strokeDasharray="2 2" strokeOpacity="0.65"/>
          ...
          {/* Right VH/VL domain */}
          <ellipse cx="132" cy="26" rx="10" ry="8" fill="#F9A8D4"/>
          {/* Right CDR loop */}
          <path d="M125 22 Q132 13 139 22" stroke="white" strokeWidth="1.6" fill="none"
            strokeOpacity="0.9" strokeLinecap="round"/>
          {/* Right CH1 domain */}
          <ellipse cx="114" cy="38" rx="8" ry="7" fill="#EC4899" opacity="0.6"/>
        ...
        <g transform="translate(85,85)">
          ...
          <g style={{transformOrigin:"0px 0px", animation:"cmc-orbit-b 6.5s linear infinite"}}>
            <circle cx="0" cy="-62" r="12" fill="#0F172A" stroke="#EC4899" strokeWidth="1.8"/>
            <circle cx="0" cy="-62" r="4" fill="#EC4899"
              style={{animation:"cmc-dot-pulse 2.8s ease-in-out infinite"}}/>
            <text x="0" y="-76" textAnchor="middle" fill="#EC4899" fontSize="7.5"
          ...
          <g style={{transformOrigin:"0px 0px", animation:"cmc-orbit-c 9s linear infinite"}}>
            <circle cx="0" cy="-73" r="12" fill="#0F172A" stroke="#06B6D4" strokeWidth="1.8"/>
            <circle cx="0" cy="-73" r="4" fill="#06B6D4"
              style={{animation:"cmc-dot-pulse 3.4s ease-in-out infinite"}}/>
            <text x="0" y="-87" textAnchor="middle" fill="#06B6D4" fontSize="7.5"
...
function Dashboard({ setView }) {
  ...
  return (
    <div style={{ maxWidth: 1400, margin: "0 auto", padding: "32px 24px" }}>
      ...
      {/* ── Hero Banner ── */}
      <div style={{
        background: "radial-gradient(circle at 1px 1px, rgba(236,72,153,0.1) 1px, transparent 0) center/28px 28px, linear-gradient(135deg, #06060F 0%, #0D0818 50%, #06060F 100%)",
        borderRadius: 20, border: "1px solid #EC489944",
        padding: "40px 48px", marginBottom: 28,
        position: "relative", overflow: "hidden",
        display: "flex", alignItems: "center", gap: 48, flexWrap: "wrap",
      }}>
        {/* Background blobs */}
        <div style={{ position:"absolute", top:-60, right:-60, width:280, height:280, borderRadius:"50%", background:"#EC489910", pointerEvents:"none" }}/>
        <div style={{ position:"absolute", bottom:-80, left:-60, width:300, height:300, borderRadius:"50%", background:"#06B6D40C", pointerEvents:"none" }}/>
        <div style={{ position:"absolute", top:"40%", right:"30%", width:180, height:180, borderRadius:"50%", background:"#A78BFA08", pointerEvents:"none" }}/>
        ...
        <div style={{ flex:"0 0 320px", display:"flex", flexDirection:"column", alignItems:"center", position:"relative", minHeight:240 }}>
          ...
          <div style={{ position:"absolute", width:260, height:260, borderRadius:"50%", border:"1px dashed #EC489928", top:"50%", left:"50%", transform:"translate(-50%,-52%)", pointerEvents:"none" }}/>
          <div style={{ position:"absolute", width:220, height:220, borderRadius:"50%", border:"1px dashed #06B6D420", top:"50%", left:"50%", transform:"translate(-50%,-52%)", pointerEvents:"none" }}/>
          <div style={{ position:"absolute", width:290, height:290, borderRadius:"50%", border:"0.5px solid #A78BFA14", top:"50%", left:"50%", transform:"translate(-50%,-52%)", pointerEvents:"none" }}/>
          {/* Cross-hair lines */}
          <div style={{ position:"absolute", top:"50%", left:"50%", transform:"translate(-50%,-52%)", width:290, height:1, background:"linear-gradient(90deg,transparent 0%,#EC489918 40%,#06B6D418 60%,transparent 100%)", pointerEvents:"none" }}/>
          <div style={{ position:"absolute", top:"50%", left:"50%", transform:"translate(-50%,-52%) rotate(90deg)", width:290, height:1, background:"linear-gradient(90deg,transparent 0%,#EC489918 40%,#06B6D418 60%,transparent 100%)", pointerEvents:"none" }}/>
          ...
          <svg style={{ position:"absolute", bottom:-8, left:8, opacity:0.55 }} width="100" height="44" viewBox="0 0 100 44" fill="none">
            <polyline points="0,40 8,40 14,38 16,22 18,6 20,22 22,38 30,39 38,40 42,40 46,28 48,14 50,28 52,40 60,40 64,38 66,34 68,38 72,40 100,40" stroke="#F472B6" strokeWidth="1.2" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
            <line x1="0" y1="43" x2="100" y2="43" stroke="#F472B6" strokeWidth="0.5" strokeOpacity="0.5"/>
            <text x="18" y="4" fill="#F472B6" fontSize="5.5" textAnchor="middle" fontFamily="system-ui">Monomer</text>
            <text x="48" y="12" fill="#BE185D" fontSize="4.5" textAnchor="middle" fontFamily="system-ui">Aggr.</text>
            <text x="67" y="31" fill="#BE185D" fontSize="4" textAnchor="middle" fontFamily="system-ui">Frag.</text>
          </svg>
          {/* Mini stability line */}
          <svg style={{ position:"absolute", bottom:-8, right:8, opacity:0.5 }} width="80" height="44" viewBox="0 0 80 44" fill="none">
            <polyline points="2,8 15,10 28,13 40,18 52,26 64,36 78,42" stroke="#06B6D4" strokeWidth="1.4" fill="none" strokeLinecap="round"/>
            <text x="2" y="6" fill="#06B6D4" fontSize="5" fontFamily="system-ui">Stability</text>
            <text x="58" y="42" fill="#06B6D4" fontSize="4" fontFamily="system-ui">t=24mo</text>
          </svg>
        ...
        <div style={{ flex:1, minWidth:280 }}>
          <div style={{ fontSize:10, fontWeight:800, color:"#F9A8D4", letterSpacing:"0.12em", marginBottom:10, textTransform:"uppercase" }}>
          ...
          <h1 style={{ fontSize:44, fontWeight:900, margin:"0 0 14px", letterSpacing:"-0.025em", lineHeight:1.1,
            background:"linear-gradient(135deg, #FFFFFF 0%, #FBCFE8 30%, #EC4899 60%, #06B6D4 100%)",
            WebkitBackgroundClip:"text", backgroundClip:"text",
            WebkitTextFillColor:"transparent", display:"inline-block" }}>
            CMC App
          </h1>
          <p style={{ color:"#FCE7F3", fontSize:15, margin:"0 0 28px", maxWidth:440, lineHeight:1.65 }}>
          ...
          <div style={{ display:"flex", gap:10, marginBottom:28, flexWrap:"wrap" }}>
            {keyStats.map(s => (
              <button key={s.label} onClick={() => setView(s.view)}
                ...
                <div style={{ color:"#FBCFE8", fontSize:10, marginTop:5, fontWeight:600, lineHeight:1.3 }}>{s.label}</div>
              </button>
            ))}
          </div>
          ...
          <div style={{ display:"flex", gap:10, flexWrap:"wrap" }}>
            <button onClick={() => setView("exam")}
              style={{ background:"linear-gradient(135deg,#9D174D,#EC4899)", color:"#fff", border:"none",
                borderRadius:10, padding:"12px 26px", cursor:"pointer", fontWeight:800, fontSize:14,
                boxShadow:"0 4px 20px #EC489944", transition:"transform 0.18s, box-shadow 0.18s" }}
              onMouseEnter={e => { e.currentTarget.style.transform="scale(1.04)"; e.currentTarget.style.boxShadow="0 6px 28px #EC489966"; }}
              onMouseLeave={e => { e.currentTarget.style.transform="scale(1)"; e.currentTarget.style.boxShadow="0 4px 20px #EC489944"; }}>
              🎯 Start Exam Mode
            </button>
            <button onClick={() => setView("pipeline")}
              style={{ background:"rgba(236,72,153,0.1)", color:"#F9A8D4", border:"1px solid #EC489950",
                borderRadius:10, padding:"12px 26px", cursor:"pointer", fontWeight:700, fontSize:14, transition:"all 0.18s" }}
              onMouseEnter={e => { e.currentTarget.style.background="#EC489922"; e.currentTarget.style.borderColor="#EC4899"; }}
              onMouseLeave={e => { e.currentTarget.style.background="rgba(236,72,153,0.1)"; e.currentTarget.style.borderColor="#EC489950"; }}>
              🗺️ Explore Pipeline
            </button>
            <button onClick={() => setView("progress")}
              style={{ background:"rgba(6,182,212,0.08)", color:"#06B6D4", border:"1px solid #06B6D450",
                borderRadius:10, padding:"12px 26px", cursor:"pointer", fontWeight:700, fontSize:14, transition:"all 0.18s" }}
              onMouseEnter={e => { e.currentTarget.style.background="#06B6D418"; e.currentTarget.style.borderColor="#06B6D4"; }}
              onMouseLeave={e => { e.currentTarget.style.background="rgba(6,182,212,0.08)"; e.currentTarget.style.borderColor="#06B6D450"; }}>
              📊 My Progress
            </button>
          </div>
        </div>
